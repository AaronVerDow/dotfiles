...
globalkeys = gears.table.join(
   ...
   awful.key({ }, "Print", function ()
       awful.util.spawn_with_shell("scrot ~/pics/screenshots/%s.png", false) end),
   awful.key({"Shift", }, "Print", function ()
       awful.util.spawn_with_shell("scrot --select ~/pics/screenshots/%s.png", false) end),
...
-- awful.spawn.with_shell("nitrogen --random ~/Pictures/mah_wallpapers/ --set-zoom-fill --head=0")
